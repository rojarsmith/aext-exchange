...
import io.aext.ocean.backend.security.SecurityMetadataSourceImpl;
import io.aext.ocean.backend.service.MemberService;
import io.aext.ocean.backend.service.PermissionService;
...
public class ApplicationStartup implements ApplicationRunner {
	...
	@Autowired
	PermissionService resourceService;
