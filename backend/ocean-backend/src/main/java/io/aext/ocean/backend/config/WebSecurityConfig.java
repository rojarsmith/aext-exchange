package io.aext.ocean.backend.config;
...
import io.aext.ocean.backend.security.AccessDeniedHandlerImpl;
import io.aext.ocean.backend.security.AuthFilter;
import io.aext.ocean.backend.security.LoginFilter;
import io.aext.ocean.backend.security.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
				...
				//
				.antMatchers("/api/v1/member/password/reset").permitAll()
				//
